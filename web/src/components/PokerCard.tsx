...
export function PokerCard(props: PokerCardProps) {
  ...
  const classes = joinClasses(
    'card-shell relative overflow-hidden rounded-[0.72rem] shadow-[0_16px_40px_rgba(0,0,0,0.24)]',
  ...
  if (!card) {
    return (
      ...
      >
        <div className="grid h-full w-full place-items-center rounded-[0.62rem] border border-white/6 bg-black/10">
